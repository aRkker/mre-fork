...
class LivestreamTest extends test_1.Test {
    constructor() {
        super(...arguments);
        this.expectedResultDescription = "Tests livestream video";
...
exports.default = LivestreamTest;
//# sourceMappingURL=livestream-test.js.map