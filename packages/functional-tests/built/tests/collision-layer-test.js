...
class CollisionLayerTest extends test_1.Test {
    constructor() {
        super(...arguments);
        this.expectedResultDescription = "Observe different collision layer interactions";
    }
    unload() {
        this.assets.unload();
    }
    ...
    createWidget(root, layer1, layer2) {
...
exports.default = CollisionLayerTest;
//# sourceMappingURL=collision-layer-test.js.map