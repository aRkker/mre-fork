...
class PhysicsCollisionTest extends test_1.Test {
    ...
    spawnBall(root, width, height, mat, userId, force, ballRadius = 0.2, killTimeout = 9000) {
...
exports.default = PhysicsCollisionTest;
