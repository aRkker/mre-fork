...
class ActorSpamTest extends test_1.Test {
    constructor() {
        super(...arguments);
        this.expectedResultDescription = "Spawn lots of actors all at once";
        this.modsOnly = true;
    }
    async run(root) {
...
exports.default = ActorSpamTest;
//# sourceMappingURL=actor-spam-test.js.map